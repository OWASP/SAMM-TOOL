                ...
                switch (dataset.type) {
                    case "line":
                        ...
                        helpers.each(dataset.data, function (dataPoint, index) {
                            var mystrokeColor = "rgba(" + hexToR(CatColor[index].toString()) + "," + hexToG(CatColor[index].toString()) + "," + hexToB(CatColor[index].toString()) + ",1)";
                            var myhighlightStroke = "rgba(" + hexToR(CatColor[index].toString()) + "," + hexToG(CatColor[index].toString()) + "," + hexToB(CatColor[index].toString()) + ",1)";
                            var myfillColor = "rgba(" + hexToR(CatColor[index].toString()) + "," + hexToG(CatColor[index].toString()) + "," + hexToB(CatColor[index].toString()) + ",1)";
                            var myhighlightFill = "rgba(" + hexToR(CatColor[index].toString()) + "," + hexToG(CatColor[index].toString()) + "," + hexToB(CatColor[index].toString()) + ",1)";
                            //Add a new point for each piece of data, passing any required data to draw.
                            datasetObject.points.push(new this.PointClass({
                                value: dataPoint,
                                label: data.labels[index],
                                datasetLabel: dataset.label,strokeColor: mystrokeColor,
                                fillColor: myfillColor,
                                highlightFill: myhighlightFill,
                                highlightStroke: myhighlightStroke
                            }));
                        }, this);
                        break;
                    ...
                    default:
                        ...
                        helpers.each(dataset.data, function (dataPoint, index) {
                            ...
                            var mystrokeColor = "rgba(" + hexToR(CatColor[index].toString()) + "," + hexToG(CatColor[index].toString()) + "," + hexToB(CatColor[index].toString()) + ",1)";
                            var myhighlightStroke = "rgba(" + hexToR(CatColor[index].toString()) + "," + hexToG(CatColor[index].toString()) + "," + hexToB(CatColor[index].toString()) + ",1)";
                            var myfillColor = "rgba(" + hexToR(CatColor[index].toString()) + "," + hexToG(CatColor[index].toString()) + "," + hexToB(CatColor[index].toString()) + ",0.75)";
                            var myhighlightFill = "rgba(" + hexToR(CatColor[index].toString()) + "," + hexToG(CatColor[index].toString()) + "," + hexToB(CatColor[index].toString()) + ",0.75)";
